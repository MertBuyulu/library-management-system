...
export const createBorrower =  createAsyncThunk("posts/createBorrower", async (borrower) => {
    try {
...
export const updateBorrower =  createAsyncThunk("posts/updateBorrower", async (id, borrower) => {
    try {
...
export const deleteBorrower =  createAsyncThunk("posts/deleteBorrower", async (id) => {
    try {
