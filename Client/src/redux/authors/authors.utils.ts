...
export const createAuthor =  createAsyncThunk("posts/createAuthor", async (author) => {
    try {
...
export const updateAuthor =  createAsyncThunk("posts/updateAuthor", async (id, author) => {
    try {
...
export const deleteAuthor =  createAsyncThunk("posts/deleteAuthor", async (id) => {
    try {
